...
export default function About() {
  ...
  return (
    <section id="about" className="py-20 bg-white dark:bg-zinc-900 border-t border-zinc-100 dark:border-zinc-800/40 transition-colors duration-300">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            >
              <span className="inline-flex items-center gap-2 text-xs font-extrabold uppercase tracking-widest text-amber-600 dark:text-amber-400">
                <span className="w-6 h-0.5 bg-amber-500 rounded-full inline-block" />
                Corporate Profile
              </span>
            ...
            <motion.div
              ...
              className="p-4 rounded-xl bg-amber-50/60 dark:bg-amber-950/20 border border-amber-200/50 dark:border-amber-900/30 flex gap-3.5 items-start max-w-xl"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {highlights.map((item, index) => (
                <motion.div
                  ...
                  className="p-5 sm:p-6 rounded-2xl bg-zinc-50 dark:bg-zinc-950/40 border border-zinc-200/50 dark:border-zinc-800/40 flex flex-col justify-between min-h-[140px] sm:h-40 shadow-sm hover:border-amber-200/60 dark:hover:border-amber-800/30 hover:shadow-md transition-all duration-200 group"
                >
                  <div className="p-2.5 bg-white dark:bg-zinc-900 rounded-xl w-max border border-zinc-200/40 dark:border-zinc-800/40 group-hover:bg-amber-50 dark:group-hover:bg-amber-950/20 transition-colors duration-200">
                    {item.icon}
                  </div>
                  <div>
                    ...
                    <span className="text-sm font-bold text-zinc-900 dark:text-white mt-1 block">
                      {item.value}
                    </span>
                  </div>
                </motion.div>
